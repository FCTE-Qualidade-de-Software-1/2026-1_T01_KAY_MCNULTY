...
graph TD
    ...
    classDef goal fill:#7cb342,stroke:#33691e,stroke-width:2px,color:#fff;
    classDef question fill:#fb8c00,stroke:#e65100,stroke-width:1px,color:#fff;
    classDef metric fill:#039be5,stroke:#0277bd,stroke-width:1px,color:#fff;
