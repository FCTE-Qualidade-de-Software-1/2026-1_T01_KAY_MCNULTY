...
| `0.5`  | Correção EU3: reescrita da seção 3 (F4-C4) citando explicitamente o propósito da Fase 1 e conectando cada resultado a uma decisão concreta para o requisitante. | 23/06/2026 | [Júlia Massuda](https://github.com/JuliaReis18) |
